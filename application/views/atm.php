            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                ?>
                        ...
                        <td><?php echo $data->atm_tahun; ?></td>


                          <td><a href="<?php echo base_url()?>detail_atm?id=<?php echo $data->atm_id?>"  ><button type="button" class="btn ink-reaction btn-raised btn-primary">Detail</button></a>
