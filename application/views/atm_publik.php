              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                ?>
                        ...
                        <td><?php echo $data->kec_nama; ?></td>                        
                          ...
                          <td><a href="<?php echo base_url()?>Publik/detail_atm_publik?id=<?php echo $data->atm_id?>">
						  <button type="button" class="btn ink-reaction btn-raised btn-primary">Detail</button></a>
                          </td>
