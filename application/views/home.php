            ...
            <div class="container">
                    <div class="col-md-12">
                        ...
                        type="text/javascript"></script>
                                ...
                                function initialize(lt,lg, nama_atm, atm_id, alamat, ) {
                                ...
                                <?php foreach ($data_atm  as $row) {?>
								  ...
								  var atm_foto =  '<?php echo $row->atm_foto ?>';
                                   ...
                                   createMarker(latview, longview, nama_atm, atm_foto);
                                <?php } ?>

                                 }
        
      
                               function createMarker(lt,lg,nama_atm,atm_foto,icon) {
                                ...
                                google.maps.event.addListener(marker, 'click', function() {
                                 var myHtml = ' <font color="black"> <strong>1. '+ nama_atm + '</strong> <br> <strong> <img src="<?php echo base_url()?>uploads/' + atm_foto + '" width="200px" height="auto">';
